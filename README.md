...
- **An AWS sandbox account**, your team's own account where you can build and deploy real AWS services (Amazon Bedrock, S3, Lambda, Polly, Textract, Translate, Comprehend, and more), not just code
